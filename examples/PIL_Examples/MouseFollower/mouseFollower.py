...
def drawArrow():
    ...
    imgTk = ImageTk.PhotoImage(img.rotate(degrees(-angle))) #Have to do -angle. img.rotate() probably rotates clockwise.
    if arrowObj == 0:
...
root.bind("<Motion>", handleMouseEvent) #Whenever the mouse moves, handleMouseEvent is called
